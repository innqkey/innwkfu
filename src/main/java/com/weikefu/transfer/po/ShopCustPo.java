...
public class ShopCustPo implements Serializable {
    ...
    public String toString() {
        ...
        sb.append(", serveruserid=").append(serveruserid);
        sb.append(", custserverstatus=").append(custserverstatus);
        sb.append(", maxusernum=").append(maxusernum);
        sb.append(", joinusernum=").append(joinusernum);
        sb.append(", createtime=").append(createtime);
        sb.append(", updatetime=").append(updatetime);
        sb.append(", onlinetimelong=").append(onlinetimelong);
