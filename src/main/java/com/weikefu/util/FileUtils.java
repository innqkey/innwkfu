...
public class FileUtils extends BaseUtils {
    ...
    public static String getApplicationPro(String key){
    ...
    public static Properties loadProperties(String fileName) {
        try {
            ...
            p.load(FileUtils.class.getClassLoader().getResourceAsStream(fileName));
            return p;
        } catch (Exception e) {
    ...
    public static void mergePartFiles(String dirPath, String partFileSuffix,
        ...
        List<File> partFiles = FileUtils.getDirFiles(dirPath,
                partFileSuffix);
