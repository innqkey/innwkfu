...
//	    System.out.println(""+days+"天"+hours+"小时"+minutes+"分");  
	     ...
	     * @throws Exception 
	     */  
	    public static String toLongYMDHMS(String shortYMDHMS) throws Exception {  
	    ...
	    public static int diffMonth(Date startDate, Date endDate) {  
	        long endMillis = endDate.getTime();  
	        long startMillis = startDate.getTime();  
	        long s = (endMillis - startMillis) / (24 * 3600 * 1000L);  
	        return (int) s;  
	    }  
	    ...
	    */  
	    ...
	    public static List getShortYMDList(String startShortYMD, String endShortYMD) throws Exception {  
	     ...
	     */  
	    @SuppressWarnings({ "rawtypes", "unchecked" })  
	    public static List getShortYMList(String startShortYM, String endShortYM) throws Exception {  
...
//	      }  
	        ...
	        public static Date addDate1(Date d,long day) throws Exception {  
