...
* 类说明：微信错误的状态吗
* @author 
* @version 创建时间：2018年1月27日 上午9:54:59
* 
*/


public class WeiXinErrorCodeUtils {
	public static String ErrorMsg(int msg) {
			    String errmsg = ""; 
			    switch (msg) { 
			    case -1: 
			      errmsg = "系统繁忙 "; 
			    ...
			    case 45024: 
			      ...
			      break; 
			    case 45047: 
			    	errmsg = "根据小程序规则，用户发送一条信息，客服48小时只能回复5条信息"; 
			    	break; 
			    case 46001: 
			      errmsg = "不存在媒体数据"; 
			      break; 
